...
- Data: `data/ui-ux/colors.csv` (20 palettes), `typography.csv` (13 pairings), `ux-guidelines.csv` (17 checks), `distinctiveness-patterns.csv` (17 flagship techniques), `sector-art-direction.csv` (10 sector recipes) — 77 rows total
