...
| `design` | ✅ Built | UI/UX & Distinctive Frontend | `references/frontend-distinctiveness.md` (flagship — always load for brand-forward work), `references/ui-ux-quickref.md`; if the user points at example sites, also `references/reference-site-analysis.md` + `scripts/ui-ux/scan.py` |
...
- Data: `data/ui-ux/colors.csv` (20 palettes), `typography.csv` (13 pairings), `ux-guidelines.csv` (17 checks), `distinctiveness-patterns.csv` (17 flagship techniques), `sector-art-direction.csv` (10 sector recipes), `reference-analysis-checklist.csv` (10 checks) — 87 rows total
...
- Script: `scripts/ui-ux/scan.py` — stdlib-only cheap first-pass scan of a reference URL's HTML/CSS (color frequency, font-family declarations, layout keyword hits) for when no live browser tool is available. `python3 scripts/ui-ux/scan.py --help`.
...
- `scripts/ui-ux/scan.py` — cheap offline scan of a reference site's HTML/CSS for color/font/layout hints (no JS rendering). `python3 scripts/ui-ux/scan.py --help`.
