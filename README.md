...
~644 data rows, 29 reference docs, 9 scripts. **Zero vendored dependencies** — no bundled venv, no `requirements.txt`.
...
python3 scripts/backend/generate.py posts --stack nextjs                   # scaffold a CRUD endpoint
```
