...
Bunun ilk hali de başarısızdı — ve bu bölümdeki en keskin ders buydu. "Kitap kapağı" için tamamen düz renkli dikdörtgenlere yaslandı, "dürüst kalalım" gerekçesiyle gerçek görselden kaçtı; sonuç bar grafiği gibi çıktı, gerçek referans sitelerinin sıcak/atmosferik hissine hiç yaklaşamadı. Kullanıcı kararı: *sorun sadece eksik fotoğraf değil, genel düzen fazla basit.* Doğru. Gösterilen versiyon yeniden yapımı: gerçek sıcak-raf fotoğrafı üzerinde tam-ekran atmosferik hero, katmanlı hikaye bandı (gerçek kütüphane-koridoru fotoğrafı + inset + döndürülmüş "1998" mühür rozeti + istatistikler), düz blok yerine gerçek sırt/kumaş/kabartma detaylı kitap objeleri, tam-ekran fotoğraflı alıntı, gerçek fotoğraflı + döndürülmüş el yazısı notlu personel rafı, editorial etkinlik listesi, ve derin forest-green bülten bandı. Gerçek Unsplash fotoğrafı açıkça-etiketli yer tutucu olarak (footer belirtiyor) — gerçek tanınabilir bir kitapçının fotoğrafı bu kurgusal dükkanınmış gibi değil, generic stok.

![Sayfa Kitabevi kitapçı sitesi](assets/screenshot-bookstore-build.png)

Üç reddedilen deneme ve bu son versiyonun ortak dersi: *ayırt edici* ve *sofistike* iki ayrı çıta, ve birincisini geçmek (şablon gibi görünme) ikincisi için (gerçekten iyi görün) hiçbir şey yapmıyor. Jenerik AI iskeletinden düz/minimal giderek kaçmak kendi başına bir başarısızlık türü.
