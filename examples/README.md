...
The files here are the raw scaffold output — deliberately unfinished, TODO-marked. For screenshots of what that starting point looks like taken to a real, finished site, see the main [README.md](../README.md#real-builds) § Real builds.
