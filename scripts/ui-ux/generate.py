...
Examples:
    ...
    python3 generate.py --palette UX091 --type UX099 --components hero,nav,footer --stack html --output ./site
"""
...
def main():
    ...
    if args.stack == "react-tailwind":
        files["tailwind.config.ts"] = TAILWIND_CONFIG.format(**roles, palette_src=palette_src, type_src=type_src)
